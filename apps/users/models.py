...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(verbose_name=u"验证码类型", choices=(("register", u"注册"), ("forget", u"找回"),("update_email", u"修改邮箱")), max_length=20)
...
class Banner(models.Model):
    ...
    image = models.ImageField(upload_to="banner/%Y/%m", verbose_name=u"首页轮播图", max_length=100)
